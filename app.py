...
st.set_page_config(page_title="Data Master - TransLogística Nacional S.A.S", page_icon="🚛", layout="wide")

st.title("🚛 Sistema de Auditoría Automática - TransLogística Nacional S.A.S")
